...
skel_128="../../insert_new/traces/parsed_100_128_2.conv.csv"
delta_128=6379600.51005
skel_4096="../../insert_new/traces/parsed_100_4096_2.conv.csv"
delta_4096=10627600.51000
...
def _conv_time(time):
    ...
    return (time - first_time)*1000 + CREATION_TIME_S
...
if __name__ == "__main__":
	...
	CREATION_TIME_S = delta_128
    else:
	CREATION_TIME_S = delta_4096
	...
	#~ if last_addrs[f] > 0:
	    #~ for j in range(0, (last_addrs[f]/3900)+1):
		#~ print str(i*1000) + ".2;write;" + str(current_filenames.index(f)+INODE_DELTA) + ";" + str(j*3900) + ";3900"
#~ 
    ...
    print str(delta) + ";dropcache"
    print str(delta) + ";reset_stats"
